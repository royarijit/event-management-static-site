...
+function(n) {
    ...
    t.prototype.toggle = function() {
        ...
        n.prop("type") == "radio" ? (n.prop("checked") && (t = !1),
        i.find(".active").removeClass("active"),
        this.$element.addClass("active")) : n.prop("type") == "checkbox" && (n.prop("checked") !== this.$element.hasClass("active") && (t = !1),
...
+function(n) {
    ...
    t.prototype.getItemForDirection = function(n, t) {
        ...
        return f && !this.options.wrap ? t : (r = n == "prev" ? -1 : 1,
...
+function(n) {
    ...
    function u(t) {
        ...
        n(i).each(function() {
            ...
            i.hasClass("open") && (t && t.type == "click" && /input|textarea/i.test(t.target.tagName) && n.contains(i[0], t.target) || (i.trigger(t = n.Event("hide.bs.dropdown", f)),
        ...
        if (!f.is(".disabled, :disabled")) {
            ...
            !o) {
                if ("ontouchstart"in document.documentElement && !i.closest(".navbar-nav").length)
                    n(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(n(this)).on("click", u);
                if (e = {
                    relatedTarget: this
                },
...
+function(n) {
    ...
    t.prototype.show = function(i) {
        ...
        !this.isShown && !u.isDefaultPrevented()) {
            this.isShown = !0;
            this.checkScrollbar();
            this.setScrollbar();
    ...
    t.prototype.escape = function() {
        if (this.isShown && this.options.keyboard)
            this.$element.on("keydown.dismiss.bs.modal", n.proxy(function(n) {
...
function(n) {
    n.fn.tabzy = function(t) {
        ...
        return this.each(function() {
            var r = n(this), u = r.find(".tabzy-item"), t, f;
            ...
            n.each(u, function(r, f) {
                var e = n(f)
                  , o = r + 1;
                if (n(f).attr("id-img", "img" + o),
                t.append(n(document.createElement("div")).css("background-image", "url(" + e.find("img").attr("src") + ")").attr("id", "img" + o)),
                i.event === "hover" && e.bind({
                    mouseenter: function() {
                        var t = n(this);
                        t.addClass("current");
            ...
            i.fullScreen == !0 && (f = n(window).height(),
            r.height(f));
...
$(function() {
    ...
    i = ['<span class="fa fa-chevron-left"><\/span>', '<span class="fa fa-chevron-right"><\/span>'];
    ...
    l = $(".wrapper");
    l.append($("<div class='scroll-top'><i class='fa fa-chevron-up'><\/i><\/div>"));
    n = $(".scroll-top");
